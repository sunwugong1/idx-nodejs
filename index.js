...
const UUID = process.env.UUID || '8586556b-da04-4f70-91f7-2292cbd335aa';  // 在不同的平台运行v1哪吒请修改UUID,否则会覆盖
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'tyong.rg520.dpdns.org';       // argo固定隧道域名,留空即使用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiNzdiNzY1YmViZjhlMGRiZDAwZjg0MjRiOTM4NWI0ZGUiLCJ0IjoiMzAwNjk5ODYtMTcxMy00MGJhLTgxZGItODAzNmZjOTk1NDRkIiwicyI6Ik1UaGhZV1ppTlRFdFlUTmtaaTAwWWpOa0xUbGtabVF0WWpoaU5qaGlNbVU0WkdSaSJ9';           // argo固定隧道token或json,留空即使用临时隧道
